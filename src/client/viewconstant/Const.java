...
public class Const {
    ...
    public static final int CARD_H = 100;
    public static final int CARD_SHOW_W = 240;
    public static final int CARD_SHOW_H = 400;
    public static final int MINION_W = 60;
    public static final int MINION_H = 100;
    //Path
