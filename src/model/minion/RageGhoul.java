...
//Complete
public class RageGhoul extends AbstractMinion implements Card, Minion, BattleCry{
    ...
    public RageGhoul (){
        super(RageGhoul.name, RageGhoul.description, RageGhoul.baseCost,
                 RageGhoul.baseHP, RageGhoul.baseATK);    
    }    
