...
import src.model.*;
//Complete
public class LootThief extends AbstractMinion implements Card, Minion, DeathRattle{
    ...
    public LootThief (){
        super(LootThief.name, LootThief.description, LootThief.baseCost,
                 LootThief.baseHP, LootThief.baseATK);    
    }
