...
import src.model.*;
//Complete
public class Pharmacist extends AbstractMinion implements Card, Minion, DeathRattle{
    ...
    public Pharmacist (){
        super(Pharmacist.name, Pharmacist.description, Pharmacist.baseCost,
                 Pharmacist.baseHP, Pharmacist.baseATK);    
    }
