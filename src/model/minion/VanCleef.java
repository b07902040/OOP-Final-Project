...
import src.model.*;
//Complete
public class VanCleef extends AbstractMinion implements Card, Minion, BattleCry, Combo{
    ...
    public VanCleef (){
        super(VanCleef.name, VanCleef.description, VanCleef.baseCost,
                 VanCleef.baseHP, VanCleef.baseATK);    
    }
