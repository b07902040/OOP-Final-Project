...
import src.model.*;
//Complete
public class VoidLord extends AbstractMinion implements Card, Minion, DeathRattle, Taunt{
    ...
    public VoidLord (){
        super(VoidLord.name, VoidLord.description, VoidLord.baseCost,
                 VoidLord.baseHP, VoidLord.baseATK);    
    }
