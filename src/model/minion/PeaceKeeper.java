...
//Complete
public class PeaceKeeper extends AbstractMinion implements Card, Minion, BattleCry, Targeting{
    ...
    public PeaceKeeper (){
        super(PeaceKeeper.name, PeaceKeeper.description, PeaceKeeper.baseCost,
                 PeaceKeeper.baseHP, PeaceKeeper.baseATK);    
    }
