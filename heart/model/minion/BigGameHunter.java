...
//Complete
public class BigGameHunter extends AbstractMinion implements Card, Minion, BattleCry, Targeting{
    ...
    public BigGameHunter (){
        super(BigGameHunter.name, BigGameHunter.description, BigGameHunter.baseCost,
                 BigGameHunter.baseHP, BigGameHunter.baseATK);    
    }
