...
//Complete
public class DreadLord extends AbstractMinion implements Card, Minion{
    ...
    public DreadLord (){
        super(DreadLord.name, DreadLord.description, DreadLord.baseCost,
                 DreadLord.baseHP, DreadLord.baseATK);    
    }    
